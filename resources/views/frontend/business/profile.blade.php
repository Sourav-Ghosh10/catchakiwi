   ...
   <div class="container">
      <div class="profile_banner">
         ...
         <div class="profile_pic-dis">
            ...
            <form name="profile_photo" id="profile_photo" enctype="multipart/form-data"
               action="{{route('store.profilepic')}}" method="POST" class="avatar-upload">
                                 ...
                                 @if($profile->dob_visibility == 1)
                                    <p>
                                       ...
                                       <input name="dateofbirth" type="text"
                                          value="{{ \Carbon\Carbon::parse($profile->dob)->format('j M Y') }}">
                                    </p>
                                 @endif
                                 <p>
                                    <label>Region</label>
                                 ...
                                 @if($profile->suburb_visibility == 1)
                                    <p>
                                       ...
                                       <input name="suburb" type="text"
                                          value="{{ $suburb->suburb_name ?? ($suburb->city_name ?? "") }}">
                                    </p>
                                 @endif
                                 <p>
                                    <label>Country</label>
                           ...
                           <div class="profile_dashboard">
                              <div id="accordion" class="prof_dasaccod">
                                 <h3 class="busi_tab">Business Listings <span
                                       class="number">{{ count($businessList) }}</span></h3>
                                       ...
                                       @if(!empty($businessList))
                                          @foreach($businessList as $business)
                                             <tr>
                                                ...
                                                <td align="left" valign="top" class="left"><a
                                                      href="{{ URL::to($country . '/business/' . $business->title_url . "/" . $business->sec_title_url . "/" . $business->slug) }}">{{ $business->display_name }}</a>
                                                </td>
                                                ...
                                                <td align="left" valign="top">
                                                   <a href="{{ URL::to($country . '/business/' . $business->title_url . "/" . $business->sec_title_url . "/" . $business->slug) }}"
                                                      class="edit">View <img src="{{ asset('assets/images/edit_icon.png') }}"
                                                         alt=""></a>
                                                </td>
                                             </tr>
                                          @endforeach
                                 ...
                                 <h3 class="nitice_tab">Notice Board <span class="number">{{ count($notice) }}</span>
                                 </h3>
                                 <div class="dash_content">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                       <tr>
                                       ...
                                       @foreach($notice as $n)
                                          <tr>
                                             ...
                                             <td align="center" valign="top"><img
                                                   src="{{ asset('assets/images/thikmark_icon.png') }}" alt=""></td>
                                             <td align="left" valign="top"><img
                                                   src="{{ asset('assets/images/view_icon.png') }}" alt=""> {{ $n->views }}
                                             </td>
                                 ...
                                 <h3 class="article_tab">Articles Posted <span
                                       class="number">{{ count($articles) }}</span></h3>
                                 <div class="dash_content">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                       <tr>
                                          <th align="center" valign="top" class="left">Heading</th>
                                       ...
                                       @foreach($articles as $article)
                                          <tr>
                                             ...
                                             <td align="center" valign="top"><img
                                                   src="{{ asset('assets/images/thikmark_icon.png') }}" alt=""></td>
                                             <td align="left" valign="top"><img
                                                   src="{{ asset('assets/images/view_icon.png') }}" alt="">
                                                {{ $article->views }}</td>
                                             <td align="left" valign="top">
                                                <a href="{{ route('article.details', $article->slug) }}" class="edit">View
                                                   <img src="{{ asset('assets/images/edit_icon.png') }}" alt=""></a>
                                             </td>
                                          </tr>
                                       @endforeach
                                    </table>
                                 ...
                                 <!--<div class="dash_content">ddvdfdfdf</div>-->
                              </div>
                           </div>
                        </div>
                        <div>
