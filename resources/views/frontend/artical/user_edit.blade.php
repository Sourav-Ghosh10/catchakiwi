                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="left_searchresults">
                        <h3><img src="{{ asset('assets/images/article_icon2.png') }}" alt=""> Articles <br>
                            <span><a href="{{ url('/') }}" style="color: #729b0f; text-decoration: none;">Home</a> > <a href="{{ route('article.list') }}" style="color: #729b0f; text-decoration: none;">Articles</a> > Edit Article</span> 
                        </h3>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-12">
                    ...
                    <div class="left_profileform">
                        <form action="{{ route('article.user-update', $article->id) }}" id="articleForm" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="tab_form">
                                <div class="acc_content" style="display:block; border-top:none;">
                                    <div class="frm_dv">
                                        <label>Article Title *</label>
                                        <input name="title" type="text" value="{{ old('title', $article->title) }}" placeholder="Enter a catchy title" required>
                                    </div>
                                    ...
                                    <div class="frm_dv">
                                        ...
                                        <div class="browse_img">
                                           @php
                                               $displayImage = $article->image ? asset($article->image) : asset('assets/images/articledefaltimg.png');
                                           ...
                                           <div class="delimgwrap" id="preview_container">
                                            ...
                                            <img class="cropimg" id="featured_image_preview" src="{{ $displayImage }}" alt="Article Image">
                                          </div>
                                            <div class="newupload">
                            ...
                            <div class="mt-4">
                                <input type="submit" value="Update & Re-submit">
                                <a href="{{ route('article.my-articles') }}" class="editcancelbtn">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
