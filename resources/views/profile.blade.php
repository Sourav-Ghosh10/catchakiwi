                                 ...
                                 <div class="chat-container">
                                    ...
                                    <div class="chat-box" id="chatBox">
                                       ...
                                       <div class="input-box" style="position: relative;">
                                           ...
                                           <button id="cancelEditBtn" type="button" onclick="cancelEdit()" title="Cancel edit" style="display:none; width:34px; height:34px; border-radius:50%; background:#e53e3e; color:#fff; border:none; font-size:16px; cursor:pointer; flex-shrink:0; margin-left:4px; align-items:center; justify-content:center; padding:0;"><i class="fa fa-times"></i></button>
                                        </div>
                                        <div class="messages"
