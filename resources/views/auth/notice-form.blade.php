...
<div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12">
                    <p class="nz_region">
                        <select class="countryChange">
                            ...
                            <option value="NZ" {{ (session('CountryCode') == "NZ") ? "selected" : "" }}>NZ-New Zealand
                            </option>
                            <option value="AU" {{ (session('CountryCode') == "AU") ? "selected" : "" }}>AU-Australia
                            </option>
                            <option value="CN" {{ (session('CountryCode') == "CN") ? "selected" : "" }}>CN-China</option>
                            <option value="ENG" {{ (session('CountryCode') == "ENG") ? "selected" : "" }}>ENG-United
                                Kingdom
                            </option>
                            <option value="US" {{ (session('CountryCode') == "US") ? "selected" : "" }}>US-United States
                            </option>
                        </select>
                    </p>
                </div>
    ...
    <div class="top_search nomob_search">
        <div class="container">
            <div class="logo">
                <h1><a href="{{ URL::to('/dashboard') }}"><img src="{{ asset('assets/images/logo-inner.png') }}"
                            alt="" /></a></h1>
            </div>
        </div>
        <!-- <div class="container">
                            ...
                            <div class="left_notice">
                                <div class="left_searchresults">
                                    <h3><img src="{{ asset('assets/images/notice_icon.png') }}" alt=""> Notice Board
                                        <br>
                                        <span><a href="{{ url('/') }}"
                                                style="color: #729b0f; text-decoration: none;">Home</a> > <a
                                    ...
                                    <div class="left_profileform notice_posefrm">
                                        ...
                                        <div id="rest_of_fields" style="display:none;">
                                            <div class="frm_dv">
                                                ...
                                                <div class="radiogbutt"><input name="noticetype" type="radio"
                                                        value="standard"> Standard 7 day Notice (Free) $0.00</div>
                                                <div class="radiogbutt"><input name="noticetype" type="radio"
                                                        value="feature"> Feature Notice(Lasts 28 days)$3.00
                                            ...
                                            <div class="frm_dv textareadv">
                                                <label id="body_label">Add your content: </label><textarea
                                                    name="notice_body" cols="" rows=""
                                                ...
                                                <div style="flex: 1;">
                                                    <div class="image-upload-grid">
                                                        ...
                                                        <div class="image-upload-box"
                                                            ...
                                                            <div id="noticeimgshow1"
                                                                class="noticeimgshow placeholder-icon">
                                                        ...
                                                        <div class="image-upload-box"
                                                            ...
                                                            <div id="noticeimgshow2"
                                                                class="noticeimgshow2 placeholder-icon">
                                                                <i class="fa fa-camera"></i>
                                                                <span>Image 2</span>
                                                            </div>
                                                            <input type="file" name="noticeimg[]" class="imageUpload"
                                                        ...
                                                        <div class="image-upload-box"
                                                            ...
                                                            <div id="noticeimgshow3"
                                                                class="noticeimgshow3 placeholder-icon">
                                                                <i class="fa fa-camera"></i>
                                                                <span>Image 3</span>
                                                            </div>
                                                            <input type="file" name="noticeimg[]" class="imageUpload"
                                            ...
                                            <div class="frm_dv" id="additional_images_section">
                                                <label><!--Notice Options:--></label>
                                                <div class="chk_addtnlbox"><input name="" type="checkbox" value=""
                                                        checked>Add 3 more images (free renewal) $2.00
                                                    <img src="images/help_icon.png" alt="" class="help_icon">
                                                </div>
                                            </div>
